...
function openPopup(assignment) {
  ...
  <hr>
  <p style="font-size: 12px">Made by: <a target="_blank" href=""></a> on Github | Website: <a target="_blank" href="">edpuzzle.hs.vc</a> | Source code: <a target="_blank" href="">/edpuzzle-answers</a>`;
